...
def attack(char_name: str, char_class: str) -> str:
    """Наносит урон противнику в зависимости от типа char_class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокирует атаку противника в зависимости от типа char_class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет специальное умение в зависимости от типа char_class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Организует тренировку в зависимости от введенных с клавитуры команд."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Определяет тип персонажа через ввод с клавиатуры."""
    approve_choice: str = ''
    char_class: str = ''
